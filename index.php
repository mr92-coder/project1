...
<html lang="en">
	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>jobs2020</h2>
						<p>A new vision for the future of employment in Sudan</p>
					</header>
					<div class="row 200%">
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-clock-o"></i>
							<p>New jobs all the time</p>
						</section>
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-comments"></i>
							<p>Direct contact with the employer</p>
						</section>
						<section class="4u$ 12u$(small)">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">jobs2020 &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">All jobs in one place</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">jobs2020<span>Sudan, khartoum</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+249900000000</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:jobs2020@gmail.com" style="color:white">contact@jobs2020.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>jobs2020</b></span>
				We are a Sudanese website specialized in bringing jobs and employees to companies
			</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="Freelancer" name="category" value="1" checked>
				                            <label for="Freelancer">Freelancer</label>
				                        </div>
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="business owner" name="category" value="0">
